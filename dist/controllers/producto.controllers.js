...
exports.ActualizarProducto = exports.ObtenerUltimoID = exports.EliminarProducto = exports.CrearProducto = exports.ObtenerProducto = exports.MostrarNovedades = exports.ListarProductos = void 0;
...
const ListarProductos = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        /* eslint-disable */ console.log(...oo_oo(`bf21eb36_0`, Productos));
...
const ObtenerProducto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        /* eslint-disable */ console.log(...oo_oo(`bf21eb36_1`, Id));
        if (Id === 0) {
...
const EliminarProducto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Id = parseInt(req.params.id);
        /* eslint-disable */ console.log(...oo_oo(`bf21eb36_2`, Id));
...
const ObtenerUltimoID = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Id = parseInt(req.params.id);
        /* eslint-disable */ console.log(...oo_oo(`bf21eb36_3`, Id));
        yield models_1.BEProducto.delete({ id: Id });
        return res.json(`Producto ${Id} Borrado satisfactoriamente`);
    }
    catch (error) {
...
exports.ObtenerUltimoID = ObtenerUltimoID;
