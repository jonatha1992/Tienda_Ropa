  ...
  <div class="bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-if="transferInfo" class="space-y-6">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div class="border border-gray-200 rounded p-4">
                <h3 class="font-medium text-gray-900 mb-3">InformaciÃ³n Bancaria</h3>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <h2 class="text-xl font-medium text-gray-900 mb-4">InformaciÃ³n de EnvÃ­o</h2>
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
            ...
            <div>
              <h3 class="font-medium text-gray-900 mb-2">DirecciÃ³n de EnvÃ­o</h3>
              <div class="text-sm">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <p class="mt-4 text-xs text-gray-500 text-center">
            RecibirÃ¡s un email de confirmaciÃ³n con estos datos. Tu pedido serÃ¡ procesado una vez que verifiquemos la transferencia.
          </p>
        </div>
      </div>
      ...
      <div v-else class="text-center py-12">
        ...
        <p class="text-gray-600">Cargando informaciÃ³n de transferencia...</p>
      </div>
    </div>
  </div>
</template>
