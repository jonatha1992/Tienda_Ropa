...
Revision ID: c6a47660f3df
Revises: 
Create Date: 2025-08-17 21:30:16.820030
...
def upgrade() -> None:
    ...
    sa.Column('address_reference', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('delivery_notes', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('preferred_delivery_time', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('payment_method', sa.Enum('TRANSFER', 'MERCADOPAGO', 'CASH', name='paymentmethod'), nullable=False),
    sa.Column('payment_status', sa.Enum('PENDING', 'PENDING_PAYMENT', 'APPROVED', 'REJECTED', 'CANCELLED', name='paymentstatus'), nullable=False),
    sa.Column('mercadopago_payment_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('mercadopago_preference_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('bank_account_info', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('transfer_receipt_url', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('delivery_time_slot', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
